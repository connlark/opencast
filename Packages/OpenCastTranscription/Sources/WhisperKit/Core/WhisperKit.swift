...
open class WhisperKit {
    ...
    @available(*, unavailable, message: "OpenCast bundles Whisper models locally and disables remote model recommendations.")
    public static func recommendedRemoteModels(
        ...
        ModelUtilities.modelSupport(for: Self.deviceName())
    }

    @available(*, unavailable, message: "OpenCast bundles Whisper models locally and disables remote model support config fetches.")
    ...
    @available(*, unavailable, message: "OpenCast bundles Whisper models locally and disables remote model listing.")
    public static func fetchAvailableModels(
        ...
        throw WhisperError.modelsUnavailable("Remote model listing is disabled in OpenCast.")
    }

    @available(*, unavailable, message: "OpenCast bundles Whisper models locally and disables remote model downloads.")
    public static func download(
        ...
        throw WhisperError.modelsUnavailable("Remote model downloads are disabled in OpenCast.")
    }
    ...
    open func setupModels(
        ...
        if let folder = modelFolder {
            ...
            throw WhisperError.modelsUnavailable("OpenCast requires a bundled local model folder.")
        }
    }
