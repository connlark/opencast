...
<description>&lt;html&gt;&lt;p&gt;A host returns for a conversation with two guests about their new book &lt;strong&gt;&lt;a href="https://example.com" target="_blank"&gt;Market Signals&lt;/a&gt;&lt;/strong&gt;. Plus we discuss orbital systems, long-term forecasts, and more.&lt;/p&gt;&lt;/html&gt;</description>
</item></channel></rss>"#;
