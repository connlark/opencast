...
pub const DEVELOPMENT_CHALLENGE_SOURCE_HASH_KEY: &str = "opencast-development-challenge-source-key";
...
pub fn challenge_source_hash_key_for_environment(
    ...
    if environment == "development" {
        return Some(DEVELOPMENT_CHALLENGE_SOURCE_HASH_KEY.to_string());
    }
