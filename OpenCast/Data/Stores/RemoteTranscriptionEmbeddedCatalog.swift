...
/// The app's embedded copy of the transcription credit catalog. Mirrors the
/// App Store product configuration and PurchaseWorker's embedded catalog;
/// the SHA-256 is over the canonical
...
nonisolated enum RemoteTranscriptionEmbeddedCatalog {
    ...
    /// Server overdraft cap: reservations may ride up to this
